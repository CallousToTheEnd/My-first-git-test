	...
	private void initialize() {
		...
		button_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				button_1_duzhechaxun();
			}
			
			private void button_1_duzhechaxun() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				String sql = "update reader set name='"+name+"',type='"+type
						+"',sex='"+sex+"',max_num="+max_num+",days_num="+days_num
						+" where id='"+id+"'";
		...
		frame.setBounds(screenwidht/2-502/2, screenhight/2-240/2, 502, 240);
